 ...
 */
package io.appium.uiautomator2.unittest.test.demo;
...
public class GestureCommandsTest extends BaseTest {
    ...
    @Test
    public void openActivity() throws JSONException {
        startActivityByUserId("com.mercedes.udc.testapp", "com.mercedes.udc.MainActivity", 14);
        Response response = findElement(By.text("Event"));
        click(response.getElementId());
        waitForSeconds(3);

        startActivityByUserId("com.mercedes.udc.testapp", "com.mercedes.udc.MainActivity", 15);
        response = findElement(By.text("Event"));
        click(response.getElementId());
        waitForSeconds(3);
    }
//
...
//        startActivity(".view.DragAndDropDemo", 2);
...
//        startActivity(".view.ChronometerDemo", 0);
//
